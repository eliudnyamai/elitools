...
if (isset($_FILES['file'])) {  
    ...
    if (move_uploaded_file($file_tmp, $compressed_image_name)) {
      ...
      $image = new \Imagick(realpath($compressed_image_name));
        ...
        $data["success"] = true;
        $data["message"] = "Image compressed successfully. </br>: <a href='php/$compressed_image_name.zip'  download><button  id='download-btn' class='btn btn-primary'>Download Compressed Image</button></a>";
      } else {
